    ...
    if num_players >= 2:
        ...
        while running:
            ...
            if game.ball.y >= game.game_area_height * 0.75 and not voted:
                # Reiniciar los votos antes de una nueva ronda de votaciones
                votes = [0, 0, 0, 0]  # Reiniciar los votos a 0 para cada nueva iteración
                # Solo permitir votar si la pelota está a poca altura de la raqueta y no se ha votado
