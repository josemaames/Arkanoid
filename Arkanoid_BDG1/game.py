...
class ArkanoidGame:
    ...
    def game_loop(self, difficulty, button_positions, font, small_font):
        ...
        while running:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    self.handle_button_click(mouse_pos, button_positions)
    ...
    def handle_button_click(self, mouse_pos, button_positions):
        """ Mover el paddle según el clic en los botones """
        for i in range(4):
